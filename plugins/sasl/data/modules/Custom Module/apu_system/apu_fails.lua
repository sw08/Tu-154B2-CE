...
defineProperty("apu_cool_fail", globalPropertyi("tu154b2/custom/failures/apu_fail_oil_cooler"))-- oil cool failure
...
if get(ismaster) ~= 1 then
	...
	if FAIL > 0 then
		...
		if fail_counter > check_time then
			...
			if get(apu_cool_fail) ~= 1 then set(apu_cool_fail, bool2int(math.random() < 0.00001 * FAIL * 0.3) * 1) end
