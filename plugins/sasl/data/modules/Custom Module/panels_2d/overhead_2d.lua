...
defineProperty("nav_1_left", globalPropertyi("tu154b2/custom/rotary/ovhd/nav_1_left")) -- левая крутилка
defineProperty("nav_1_right", globalPropertyi("tu154b2/custom/rotary/ovhd/nav_1_right")) -- правая крутилка

defineProperty("nav_1_mile_km", globalPropertyi("tu154b2/custom/switchers/nav_1_mile_km")) -- режим мили - км

defineProperty("nav_1_but_1", globalPropertyi("tu154b2/custom/buttons/ovhd/nav_1_but_1")) -- кнопка 1
defineProperty("nav_1_but_2", globalPropertyi("tu154b2/custom/buttons/ovhd/nav_1_but_2")) -- кнопка 2
defineProperty("nav_1_but_3", globalPropertyi("tu154b2/custom/buttons/ovhd/nav_1_but_3")) -- кнопка 3


defineProperty("nav_2", globalPropertyf("sim/cockpit2/radios/actuators/nav2_frequency_hz"))  -- set the frequency
defineProperty("nav_2_left", globalPropertyi("tu154b2/custom/rotary/ovhd/nav_2_left")) -- левая крутилка
defineProperty("nav_2_right", globalPropertyi("tu154b2/custom/rotary/ovhd/nav_2_right")) -- правая крутилка

defineProperty("nav_2_mile_km", globalPropertyi("tu154b2/custom/switchers/nav_2_mile_km")) -- режим мили - км

defineProperty("nav_2_but_1", globalPropertyi("tu154b2/custom/buttons/ovhd/nav_2_but_1")) -- кнопка 1
defineProperty("nav_2_but_2", globalPropertyi("tu154b2/custom/buttons/ovhd/nav_2_but_2")) -- кнопка 2
defineProperty("nav_2_but_3", globalPropertyi("tu154b2/custom/buttons/ovhd/nav_2_but_3")) -- кнопка 3

-- VHF
defineProperty("vhf_1", globalPropertyf("sim/cockpit2/radios/actuators/com1_frequency_hz"))  -- set the frequency
defineProperty("vhf_1_left", globalPropertyi("tu154b2/custom/rotary/ovhd/vhf_1_left"))  -- knob
defineProperty("vhf_1_right", globalPropertyi("tu154b2/custom/rotary/ovhd/vhf_1_right"))  -- knob

defineProperty("vhf_2", globalPropertyf("sim/cockpit2/radios/actuators/com2_frequency_hz"))  -- set the frequency
defineProperty("vhf_2_left", globalPropertyi("tu154b2/custom/rotary/ovhd/vhf_2_left"))  -- knob
defineProperty("vhf_2_right", globalPropertyi("tu154b2/custom/rotary/ovhd/vhf_2_right"))  -- knob

-- ARK
defineProperty("ark_1_mode", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_mode")) -- режим АРК 1 0 - выкл, 1 - комп, 2 - ант, 3 - рам
defineProperty("ark_1_channel", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_channel")) -- канал АРК 1
defineProperty("ark_1_hundr_left", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_hundr_left")) -- сотни частоты 1 - 17
defineProperty("ark_1_tens_left", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_tens_left")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_1_ones_left", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_ones_left")) -- единицы частоты 0 - 9
defineProperty("ark_1_hundr_right", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_hundr_right")) -- сотни частоты 1 - 17
defineProperty("ark_1_tens_right", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_tens_right")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_1_ones_right", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_1_ones_right")) -- единицы частоты 0 - 9

defineProperty("ark_1_ramka", globalPropertyi("tu154b2/custom/buttons/ovhd/ark_1_ramka")) -- кнопка рамки


defineProperty("ark_2_mode", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_mode")) -- режим АРК 1 0 - выкл, 1 - комп, 2 - ант, 3 - рам
defineProperty("ark_2_channel", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_channel")) -- канал АРК 1
defineProperty("ark_2_hundr_left", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_hundr_left")) -- сотни частоты 1 - 17
defineProperty("ark_2_tens_left", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_tens_left")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_2_ones_left", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_ones_left")) -- единицы частоты 0 - 9
defineProperty("ark_2_hundr_right", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_hundr_right")) -- сотни частоты 1 - 17
defineProperty("ark_2_tens_right", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_tens_right")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_2_ones_right", globalPropertyi("tu154b2/custom/switchers/ovhd/ark_2_ones_right")) -- единицы частоты 0 - 9

defineProperty("ark_2_ramka", globalPropertyi("tu154b2/custom/buttons/ovhd/ark_2_ramka")) -- кнопка рамки
...
defineProperty("transponder_emerg_cap", globalPropertyi("tu154b2/custom/buttons/ovhd/transponder_emerg_cap"))
...
defineProperty("bkk_ok", globalPropertyf("tu154b2/custom/lights/small/bkk_ok")) -- лампа исправности БКК
...
-- load images
defineProperty("bg_img", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 0, 0, 1458, 1013))
...
defineProperty("sw_left_img", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1624, 288, 100, 36))
defineProperty("sw_right_img", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1624, 328, 100, 36))

defineProperty("big_sw_dn_img", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1956, 13, 39, 102))
defineProperty("big_sw_up_img", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 2000, 12, 39, 102))

defineProperty("red_cap_up", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1466, 134, 56, 42))
defineProperty("blue_cap_up", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1524, 236, 56, 42))
defineProperty("black_cap_up", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1466, 285, 56, 42))

defineProperty("em_light_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1467, 182, 56, 95))
defineProperty("mgv_ctr_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1523, 134, 56, 95))
defineProperty("pkp_right_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1578, 134, 56, 95))
defineProperty("pkp_left_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1634, 134, 56, 95))
defineProperty("sau_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1692, 134, 56, 95))
defineProperty("bkk_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1750, 134, 56, 95))
defineProperty("bkk_test_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1805, 134, 56, 95))
defineProperty("taws_main_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1467, 334, 56, 95))
defineProperty("taws_36_cap_dn", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1525, 334, 56, 95))

defineProperty("big_rotary_sw", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1788, 19, 27, 80))
defineProperty("small_rotary_sw", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1740, 19, 38, 80))


defineProperty("ark_big_num", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1473, 5, 108, 108))
defineProperty("ark_mid_num", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1594, 23, 72, 72))
defineProperty("ark_small_num", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1676, 34, 50, 50))

defineProperty("big_scale", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1889, 155, 159, 159))
defineProperty("tks_handle", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1866, 319, 47, 47))


defineProperty("small_lamp", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1825, 299, 19, 19))
defineProperty("tks_main_lamp", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1935, 329, 32, 32))
defineProperty("tks_aux_lamp", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1982, 329, 32, 32))

defineProperty("trans_cap_open", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1469, 449, 46, 32))
defineProperty("trans_cap_closed", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex.png", 1469, 487, 46, 49))




-- rus tex
defineProperty("bg_img_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 0, 0, 1458, 1013))

defineProperty("em_light_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1467, 182, 56, 95))
defineProperty("mgv_ctr_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1523, 134, 56, 95))
defineProperty("pkp_right_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1578, 134, 56, 95))
defineProperty("pkp_left_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1634, 134, 56, 95))
defineProperty("sau_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1692, 134, 56, 95))
defineProperty("bkk_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1750, 134, 56, 95))
defineProperty("taws_main_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1467, 334, 56, 95))
defineProperty("taws_36_cap_dn_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1525, 334, 56, 95))

defineProperty("big_scale_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1889, 155, 159, 159))

defineProperty("tks_main_lamp_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1935, 329, 32, 32))
defineProperty("tks_aux_lamp_RUS", loadImage(moduleDirectory .."/Custom Module/panels_2d/overhead_tex_RUS.png", 1982, 329, 32, 32))
...
local so72_font = loadBitmapFont(moduleDirectory .."/Custom Module/digital7_space.fnt")
...
function update()
	...
	-- cursMP 1
	nav_1_power = get(curs_np_on_1) == 1 and get(bus36_volt_pts250_2) > 30 and get(bus115_1_volt) > 100
	...
	-- cursMP 2
	nav_2_power = get(curs_np_on_2) == 1 and get(bus36_volt_right) > 30 and get(bus115_3_volt) > 100
