...
function draw()
 drawAll(components)
 drawBitmapText(font, 10, 264, METAR1, 1.0, 1.0, 1.0)
 drawBitmapText(font, 10, 237, METAR2, 1.0, 1.0, 1.0)
 drawBitmapText(font, 10, 210, METAR3, 1.0, 1.0, 1.0)
 drawBitmapText(font, 10, 183, METAR4, 1.0, 1.0, 1.0)
 drawBitmapText(font, 10, 156, METAR5, 1.0, 1.0, 1.0)
 drawBitmapText(font, 10, 129, METAR6, 1.0, 1.0, 1.0)
 drawBitmapText(font, 10, 92, input, 1.0, 1.0, 1.0)
