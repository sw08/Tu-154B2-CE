...
-- fuel pumps work
defineProperty("pump_tank2_left1_work", globalPropertyi("tu154b2/custom/fuel/pump_tank2_left_work1")) -- number of working pumps
...
defineProperty("trans_left", globalPropertyi("sim/cockpit2/fuel/transfer_pump_left"))
defineProperty("trans_right", globalPropertyi("sim/cockpit2/fuel/transfer_pump_right"))
...
--]]	
	...
	-- check pumps work
	local pump2L = (get(pump_tank2_left1_work)+get(pump_tank2_left2_work)) * spd * tank2L_rnd -- tank can give fuel
	local pump2R = (get(pump_tank2_right1_work)+get(pump_tank2_right2_work)) * spd * tank2R_rnd -- tank can give fuel
	local pump3L = (get(pump_tank3_left1_work)+get(pump_tank3_left2_work)+get(pump_tank3_left3_work)) * spd * tank3L_rnd -- tank can give fuel
	local pump3R = (get(pump_tank3_right1_work)+get(pump_tank3_right2_work)+get(pump_tank3_right3_work)) * spd * tank3R_rnd -- tank can give fuel	
	local pump4 = (get(pump_tank41_work)+get(pump_tank42_work)) * spd -- tank can give fuel	
