...
local screen_work = get(mode_set) == 2 and (get(kont_left)==2 or get(kont_right)==2) and get(kont)==1
...
function update()
	...
	screen_work = get(mode_set) == 2 and (get(kont_left)==2 or get(kont_right)==2) and get(kont)==1
