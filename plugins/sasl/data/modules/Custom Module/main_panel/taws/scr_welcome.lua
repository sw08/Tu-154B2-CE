...
-- images
defineProperty("wc_screen_img", loadImage(moduleDirectory .. "/Custom Module/main_panel/taws/taws_welcome.png", 0, 0, 1000, 770))
...
function update()
	...
	if not screen_work then 
		...
		elseif time_counter >= 8 then --and time_counter < 62 then
