...
defineProperty("mode_set", globalPropertyi("tu154b2/custom/taws/mode_set")) -- режим работы экрана. 0 - выкл, 1 - карта высот, 2 - вид сбоку, 3 - часы, 4 - процесс включения, 5 - игра
...
local pong_sound = loadSample(moduleDirectory .. '/Custom Sounds/pong.wav') --
local sqr_sound = loadSample(moduleDirectory .. '/Custom Sounds/square.wav') --
...
if screen_work then
	...
	drawBitmapText(text_font, 10, 350, "P: "..player.life, 1,1,1,1)
	drawBitmapText(text_font, 100, 350, "LVL: "..level, 1,1,1,1)
	drawBitmapText(text_font, 250, 350, "PTS: "..score, 1,1,1,1)
	
	if game_lost then
		drawBitmapText(text_font, 130, 210, "GAME OVER", 1,1,1,1)
		drawBitmapText(text_font, 40, 150, "PRESS MOD TO EXIT", 1,1,1,1)
		drawBitmapText(text_font, 15, 100, "PRESS BUT2 TO RESET", 1,1,1,1)
	end
	
	if not game_started then
		drawBitmapText(text_font, 160, 170, "LEVEL: "..level, 1,1,1,1)
	end
