...
-- clock 1 - captain
defineProperty("needle_hours_1", globalPropertyf("tu154b2/custom/gauges/acs1/needle_hours"))
defineProperty("needle_mins_1", globalPropertyf("tu154b2/custom/gauges/acs1/needle_mins"))

defineProperty("flight_timer_hours_1", globalPropertyf("tu154b2/custom/gauges/acs1/flight_timer_hours"))
defineProperty("flight_timer_mins_1", globalPropertyf("tu154b2/custom/gauges/acs1/flight_timer_mins"))

defineProperty("stopwatch_mins_1", globalPropertyf("tu154b2/custom/gauges/acs1/stopwatch_mins"))
defineProperty("needle_secs_1", globalPropertyf("tu154b2/custom/gauges/acs1/needle_secs"))

defineProperty("LK1", globalPropertyi("tu154b2/custom/gauges/acs1/left_knob_press"))
defineProperty("RK1", globalPropertyi("tu154b2/custom/gauges/acs1/right_knob_press"))
defineProperty("flag_pos_1", globalPropertyi("tu154b2/custom/gauges/acs1/flag_pos"))

-- clock 2 - copilot
defineProperty("needle_hours_2", globalPropertyf("tu154b2/custom/gauges/acs2/needle_hours"))
defineProperty("needle_mins_2", globalPropertyf("tu154b2/custom/gauges/acs2/needle_mins"))

defineProperty("flight_timer_hours_2", globalPropertyf("tu154b2/custom/gauges/acs2/flight_timer_hours"))
defineProperty("flight_timer_mins_2", globalPropertyf("tu154b2/custom/gauges/acs2/flight_timer_mins"))

defineProperty("stopwatch_mins_2", globalPropertyf("tu154b2/custom/gauges/acs2/stopwatch_mins"))
defineProperty("needle_secs_2", globalPropertyf("tu154b2/custom/gauges/acs2/needle_secs"))

defineProperty("LK2", globalPropertyi("tu154b2/custom/gauges/acs2/left_knob_press"))
defineProperty("RK2", globalPropertyi("tu154b2/custom/gauges/acs2/right_knob_press"))
defineProperty("flag_pos_2", globalPropertyi("tu154b2/custom/gauges/acs2/flag_pos"))

-- clock 3 - engineer
defineProperty("needle_hours_3", globalPropertyf("tu154b2/custom/gauges/acs3/needle_hours"))
defineProperty("needle_mins_3", globalPropertyf("tu154b2/custom/gauges/acs3/needle_mins"))

defineProperty("flight_timer_hours_3", globalPropertyf("tu154b2/custom/gauges/acs3/flight_timer_hours"))
defineProperty("flight_timer_mins_3", globalPropertyf("tu154b2/custom/gauges/acs3/flight_timer_mins"))

defineProperty("stopwatch_mins_3", globalPropertyf("tu154b2/custom/gauges/acs3/stopwatch_mins"))
defineProperty("needle_secs_3", globalPropertyf("tu154b2/custom/gauges/acs3/needle_secs"))

defineProperty("LK3", globalPropertyi("tu154b2/custom/gauges/acs3/left_knob_press"))
defineProperty("RK3", globalPropertyi("tu154b2/custom/gauges/acs3/right_knob_press"))
defineProperty("flag_pos_3", globalPropertyi("tu154b2/custom/gauges/acs3/flag_pos"))
...
local btn_click_L = loadSample(moduleDirectory .. '/Custom Sounds/acs_btn_L.wav')
local tik_tak_L = loadSample(moduleDirectory .. '/Custom Sounds/acs_tik_tik_L.wav')
local btn_click_R = loadSample(moduleDirectory .. '/Custom Sounds/acs_btn_R.wav')
local tik_tak_R = loadSample(moduleDirectory .. '/Custom Sounds/acs_tik_tik_R.wav')
playSample(tik_tak_L,true)
playSample(tik_tak_R,true)

local panel_x=-0.76623
local panel_z=-22.98833
local panel2_x=0.7697777
local panel2_z=-22.98682
local panel3_x=0.7097411
local panel3_z=-20.733282
local dist_gain=5
...
local function knob_work()
	...
	local knob_summ1 = get(LK1) + get(RK1) 
	local knob_summ2 =get(LK2) + get(RK2) 
	local knob_summ3 =get(LK3) + get(RK3)
	
	local z_pos=get(pilot_Z)
	local x_pos=get(pilot_X)
	local plt_hdg=get(pilot_head)
	local gain1_L, gain1_R = inn_balance (panel_x, panel_z, x_pos, z_pos , plt_hdg)
	gain1_L=gain1_L*1000
	gain1_R=gain1_R*1000
	local dist1=1
	...
	if z_pos-panel_z~=0 then
		dist1=math.min(1,1/math.sqrt(math.pow(z_pos-panel_z,2)+math.pow(x_pos-panel_x,2))/dist_gain)
	end
	...
	gain3_L=gain3_L*1000
	gain3_R=gain3_R*1000
	local dist3=1
	if z_pos-panel3_z~=0 then
		dist3=math.min(1,1/math.sqrt(math.pow(z_pos-panel3_z,2)+math.pow(x_pos-panel3_x,2))/dist_gain)
	end
	setSampleGain(tik_tak_L,math.max(gain1_L*dist1,gain2_L*dist2,gain3_L*dist3)/4*bool2int(passed>0 and external==0))
	setSampleGain(tik_tak_R,math.max(gain1_R*dist1,gain2_R*dist2,gain3_R*dist3)/4*bool2int(passed>0 and external==0))
	
	if knob1_last < knob_summ1 then 		
		setSampleGain(btn_click_L,gain1_L*dist1)
		setSampleGain(btn_click_R,gain1_R*dist1)
		playSample(btn_click_L, false)
		playSample(btn_click_R, false)
	end
	
	if knob2_last < knob_summ2 then 				
		setSampleGain(btn_click_L,gain2_L*dist2)
		setSampleGain(btn_click_R,gain2_R*dist2)
		playSample(btn_click_L, false)
		playSample(btn_click_R, false)
	end
	
	if knob3_last < knob_summ3 then 		
		setSampleGain(btn_click_L,gain3_L*dist3)
		setSampleGain(btn_click_R,gain3_R*dist3)
		playSample(btn_click_L, false)
		playSample(btn_click_R, false)
	end
	
	knob1_last = knob_summ1
	knob2_last = knob_summ2
	knob3_last = knob_summ3
