...
defineProperty("font", loadFont(moduleDirectory.."/Custom Module/AVIA.ttf"))
...
function draw()
	local c = get(color)
	drawBitmapText(get(font), 0, 0, get(text), get(font_size), false, false, TEXT_ALIGN_LEFT, { c[1], c[2], c[3], c[4] })
end
