...
defineProperty("side",globalPropertyi("tu154b2/custom/checklist/side")) -- какую сторону показывать. 0 - пред взлетом, 1 - перед заходом

defineProperty("fishka_1",globalPropertyi("tu154b2/custom/checklist/fishka_1")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_2",globalPropertyi("tu154b2/custom/checklist/fishka_2")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_3",globalPropertyi("tu154b2/custom/checklist/fishka_3")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_4",globalPropertyi("tu154b2/custom/checklist/fishka_4")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_5",globalPropertyi("tu154b2/custom/checklist/fishka_5")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_6",globalPropertyi("tu154b2/custom/checklist/fishka_6")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_7",globalPropertyi("tu154b2/custom/checklist/fishka_7")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_8",globalPropertyi("tu154b2/custom/checklist/fishka_8")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_9",globalPropertyi("tu154b2/custom/checklist/fishka_9")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_10",globalPropertyi("tu154b2/custom/checklist/fishka_10")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_11",globalPropertyi("tu154b2/custom/checklist/fishka_11")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_12",globalPropertyi("tu154b2/custom/checklist/fishka_12")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_13",globalPropertyi("tu154b2/custom/checklist/fishka_13")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_14",globalPropertyi("tu154b2/custom/checklist/fishka_14")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_15",globalPropertyi("tu154b2/custom/checklist/fishka_15")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_16",globalPropertyi("tu154b2/custom/checklist/fishka_16")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_17",globalPropertyi("tu154b2/custom/checklist/fishka_17")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_18",globalPropertyi("tu154b2/custom/checklist/fishka_18")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_19",globalPropertyi("tu154b2/custom/checklist/fishka_19")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_20",globalPropertyi("tu154b2/custom/checklist/fishka_20")) -- положение фишки. 0 - слева, 1 - справа

defineProperty("checklist_selected",globalPropertyi("tu154b2/custom/checklist/checklist_selected")) -- выбор чеклиста
...
defineProperty("door1", globalPropertyf("tu154b2/custom/lights/left_front_pax_door")) -- левая передняя дверь открыта
defineProperty("door2", globalPropertyf("tu154b2/custom/lights/left_mid_pax_door")) -- левая средняя дверь открыта
defineProperty("door3", globalPropertyf("tu154b2/custom/lights/right_mid_pax_door")) -- средняя средняя дверь открыта
defineProperty("door4", globalPropertyf("tu154b2/custom/lights/cargo_front_door")) -- передний багажный люк
defineProperty("door5", globalPropertyf("tu154b2/custom/lights/cargo_back_door")) -- задний багажный люк
...
defineProperty("cg_pos_actual", globalPropertyf("tu154b2/custom/misc/cg_pos_actual")) -- актуальное положение CG
defineProperty("weight_actual", globalPropertyf("tu154b2/custom/misc/weight_actual")) -- актуальная масса

defineProperty("v1_15", globalPropertyi("tu154b2/custom/speeds/v1_15")) -- 
defineProperty("vr_15", globalPropertyi("tu154b2/custom/speeds/vr_15")) -- 
defineProperty("v2_15", globalPropertyi("tu154b2/custom/speeds/v2_15")) -- 
defineProperty("v1_28", globalPropertyi("tu154b2/custom/speeds/v1_28")) -- 
defineProperty("vr_28", globalPropertyi("tu154b2/custom/speeds/vr_28")) -- 
defineProperty("v2_28", globalPropertyi("tu154b2/custom/speeds/v2_28")) -- 
...
function checklist_1()
	...
	if stage == 6 and speak_timer == 0 then
		...
		-- false answer
		if stage_status == 1 and (get(gs_press_1) < 145 or get(gs_press_2) < 145 or get(gs_press_3) < 145) then
			-- say false answer once
			local num = find_empty()
			phrases_tbl[num] = {eng_tbl["fail_"..math.random(1,5)][lang], 1}
			speak_timer = 1
		...
		-- true answer
		if (stage_status == 1 or stage_status == 2) and get(gs_press_1) >= 150 and get(gs_press_2) >= 150 and get(gs_press_3) >= 150 then
			local num = find_empty()
