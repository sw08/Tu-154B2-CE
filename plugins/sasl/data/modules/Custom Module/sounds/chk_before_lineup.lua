...
defineProperty("vbe_pressure", globalPropertyf("tu154b2/custom/gauges/alt/vbe_press_left"))  -- pressure in hPa
defineProperty("vbe_on_1", globalPropertyi("tu154b2/custom/switchers/ovhd/vbe_1_on"))

defineProperty("vbe_on_2", globalPropertyi("tu154b2/custom/switchers/ovhd/vbe_2_on"))

--- kontur_90th

defineProperty("kontur_90th", globalPropertyi("sim/custom/b2/kontur_90th"))

defineProperty("rv_flag_1", globalPropertyi("tu154b2/custom/gauges/alt/radioalt_flag_left"))  -- RV flag
defineProperty("rv_flag_2", globalPropertyi("tu154b2/custom/gauges/alt/radioalt_flag_right"))  -- RV flag
...
defineProperty("pkp_fail_left", globalPropertyi("tu154b2/custom/bkk/pkp_fail_left")) -- сигнал с БКК - отказ левого ПКП
defineProperty("pkp_fail_right", globalPropertyi("tu154b2/custom/bkk/pkp_fail_right")) -- сигнал с БКК - отказ левого ПКП	
defineProperty("pitch_corr_hdl_1", globalPropertyf("tu154b2/custom/gauges/ahz/pitch_corr_L")) -- коррекция тангажа на АГР + вправо
defineProperty("pitch_corr_hdl_2", globalPropertyf("tu154b2/custom/gauges/ahz/pitch_corr_R")) -- коррекция тангажа на АГР + вправо
...
function checklist_4()
	...
	if get(kontur_90th) < 1 then
		if stage_status == 1 and get(vbe_on_1) * (1 - get(rv_flag_1)) * (1 - get(rv_flag_2)) == 0 then
		...
		-- true answer
		if (stage_status == 1 or stage_status == 2) and get(vbe_on_1) * (1 - get(rv_flag_1)) * (1 - get(rv_flag_2)) == 1 then
			local num = find_empty()
