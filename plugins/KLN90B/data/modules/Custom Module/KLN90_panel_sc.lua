...
defineProperty("sc_scaleline", globalPropertys("tu154b2/custom/KLN90/scale_line"))
defineProperty("sc_graphNAV5Comp", globalPropertys("tu154b2/custom/graphNAV5Comp"))
defineProperty("sc_graphAPT3Comp", globalPropertys("tu154b2/custom/graphAPT3Comp"))
...
function update()
	...
	-- end
	local sc_gstring_1=get(sc_gline_1)
	local sc_gstring_2=get(sc_gline_2)
	local sc_gstring_3=get(sc_gline_3)
	local sc_gstring_4=get(sc_gline_4)
	local sc_gstring_5=get(sc_gline_5)
	local sc_gstring_6=get(sc_gline_6)
	local sc_gstring_7=get(sc_gline_6)
	
	local sc_bstring_1=get(sc_bline_1)
	local sc_bstring_2=get(sc_bline_2)
	local sc_bstring_3=get(sc_bline_3)
	local sc_bstring_4=get(sc_bline_4)
	local sc_bstring_5=get(sc_bline_5)
	local sc_bstring_6=get(sc_bline_6)
	local sc_bstring_7=get(sc_bline_6)
	local test_string="0000000000000000000000000"
	if MASTER ~= 1 then	
		if sc_gstring_1==test_string then
			set(sc_gline_1, gline[1])
		end
		if sc_gstring_2==test_string then
			set(sc_gline_2, gline[2])
		end
		if sc_gstring_3==test_string then
			set(sc_gline_3, gline[3])
		end
		if sc_gstring_4==test_string then
			set(sc_gline_4, gline[4])
		end
		if sc_gstring_5==test_string then
			set(sc_gline_5, gline[5])
		end
		if sc_gstring_6==test_string then
			set(sc_gline_6, gline[6])
		end
		if sc_gstring_7==test_string then
			set(sc_gline_7, gline[7])
		end

		if sc_bstring_1==test_string then
			set(sc_bline_1, bline[1])
		end
		if sc_bstring_2==test_string then
			set(sc_bline_2, bline[2])
		end
		if sc_bstring_3==test_string then
			set(sc_bline_3, bline[3])
		end
		if sc_bstring_4==test_string then
			set(sc_bline_4, bline[4])
		end
		if sc_bstring_5==test_string then
			set(sc_bline_5, bline[5])
		end
		if sc_bstring_6==test_string then
			set(sc_bline_6, bline[6])
		end
		if sc_bstring_7==test_string then
			set(sc_bline_7, bline[7])
		end				
		...
		set(sc_cage, cagevisible)
			...
			if sc_gstring_1~=test_string then
				gline_sc[1]=sc_gstring_1
				set(sc_gline_1,test_string)				
			end
			if sc_gstring_2~=test_string then
				gline_sc[2]=sc_gstring_2
				set(sc_gline_2, test_string)
			end
			if sc_gstring_3~=test_string then
				gline_sc[3]=sc_gstring_3
				set(sc_gline_3, test_string)
			end
			if sc_gstring_4~=test_string then
				gline_sc[4]=sc_gstring_4
				set(sc_gline_4, test_string)
			end
			if sc_gstring_5~=test_string then
				gline_sc[5]=sc_gstring_5
				set(sc_gline_5, test_string)
			end
			if sc_gstring_6~=test_string then
				gline_sc[6]=sc_gstring_6
				set(sc_gline_6, test_string)
			end
			if sc_gstring_7~=test_string then
				gline_sc[7]=sc_gstring_7
				set(sc_gline_7, test_string)
			end
			
			if sc_bstring_1~=test_string then
				bline_sc[1]=sc_bstring_1
				set(sc_bline_1, test_string)
			end
			if sc_bstring_2~=test_string then
				bline_sc[2]=sc_bstring_2
				set(sc_bline_2, test_string)
			end
			if sc_bstring_3~=test_string then
				bline_sc[3]=sc_bstring_3
				set(sc_bline_3, test_string)
			end
			if sc_bstring_4~=test_string then
				bline_sc[4]=sc_bstring_4
				set(sc_bline_4, test_string)
			end
			if sc_bstring_5~=test_string then
				bline_sc[5]=sc_bstring_5
				set(sc_bline_5, test_string)
			end
			if sc_bstring_6~=test_string then
				bline_sc[6]=sc_bstring_6
				set(sc_bline_6, test_string)
			end
			if sc_bstring_7~=test_string then
				bline_sc[7]=sc_bstring_7
				set(sc_bline_7, test_string)
			end
			cagevisible=get(sc_cage)				
			-- set(sc_graphNAV5Comp, "")
			-- set(sc_graphAPT3Comp, "")
...
function draw()
		if draw3d == true then
			if get(ismaster)==1 then
				...
				sasl.gl.drawBitmapText(font, 1, 69, gline_sc[1], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(font, 1, 58, gline_sc[2], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(font, 1, 47, gline_sc[3], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(font, 1, 36, gline_sc[4], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(font, 1, 25, gline_sc[5], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(font, 1, 14, gline_sc[6], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(font, 1, 0, gline_sc[7], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 69, bline_sc[1], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 58, bline_sc[2], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 47, bline_sc[3], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 36, bline_sc[4], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 25, bline_sc[5], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 14, bline_sc[6], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
				sasl.gl.drawBitmapText(fontb, 1, 0, bline_sc[7], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
